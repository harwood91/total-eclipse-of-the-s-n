		...
		<div class="streamlined-updates feature-section one-col">
			...
			if ( ! wp_is_mobile() ) {
				...
				echo wp_video_shortcode( array(
					'mp4'      => 'https://s.w.org/img/core/4.6/streamlined-updates.mp4',
					'webm'     => 'https://s.w.org/img/core/4.6/streamlined-updates.webm',
					'poster'   => 'https://s.w.org/img/core/4.6/streamlined-updates-2000.png?v1',
					'loop'     => true,
					'autoplay' => true,
					'width'    => 1050,
					'height'   => 630,
				...
				echo '<img src="https://s.w.org/img/core/4.6/streamlined-updates-1057.png?v1" alt="" srcset="https://s.w.org/img/core/4.6/streamlined-updates-1664.png?v1 1664w, https://s.w.org/img/core/4.6/streamlined-updates-200.png?v1 200w, https://s.w.org/img/core/4.6/streamlined-updates-1057.png?v1 1057w, https://s.w.org/img/core/4.6/streamlined-updates-2000.png?v1 2000w"  sizes="(max-width: 500px) calc(100vw - 40px), (max-width: 782px) calc(100vw - 70px), (max-width: 959px) calc(100vw - 116px), (max-width: 1290px) calc(100vw - 240px), 1050px" />';
			}
			?>
		</div>
