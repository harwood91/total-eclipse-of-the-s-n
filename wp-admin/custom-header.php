...
class Custom_Image_Header {
	...
	public function help() {
		get_current_screen()->add_help_tab( array(
			...
			'content' =>
				...
				'<p>' . __( 'You can choose from the theme&#8217;s default header img, or use one of your own. You can also customize how your Site Title and Tagline are displayed.') . '<p>'
		) );
		...
		get_current_screen()->add_help_tab( array(
			...
			'content' =>
				...
				'<p>' . __( 'Some themes come with additional header img bundled. If you see multiple img displayed, select the one you&#8217;d like and click the &#8220;Save Changes&#8221; button.' ) . '</p>' .
	 ...
	 *
	 * Show the random image option if this theme has multiple header img.
...
<form method="post" action="<?php echo esc_url(add_query_arg('step', 3)); ?>">
	 ...
	 * 	for randomly cycling among the default img; 'random-uploaded-image', for randomly cycling
	 * 	among the uploaded img; the key of a default image registered for that theme; and
