...
if ( 'post' == $post_type ) {
	...
	$title_and_editor .= '<p>' . __( 'You can insert media files by clicking the icons above the post editor and following the directions. You can align or edit img using the inline formatting toolbar available in Visual mode.' ) . '</p>';
	...
	get_current_screen()->add_help_tab( array(
		...
		'content' =>
			...
			'<p>' . __('For img only, you can click on Edit Image under the thumbnail to expand out an inline image editor with icons for cropping, rotating, or flipping the image as well as for undoing and redoing. The boxes on the right give you more options for scaling the image, for cropping it, and for cropping the thumbnail in a different way than you crop the original image. You can click on Help in those boxes to get more information.') . '</p>' .
...
if ( 'post' == $post_type || 'page' == $post_type ) {
	$inserting_media = '<p>' . __( 'You can upload and insert media (img, audio, documents, etc.) by clicking the Add Media button. You can select from the img and files already uploaded to the Media Library, or upload new media to add to your page or post. To create an image gallery, select the img to add and click the &#8220;Create a new gallery&#8221; button.' ) . '</p>';
