...
<?php } ?>
	...
	resetImageData : function() {
		...
		else document.getElementById('status_img').innerHTML = '<img src="<?php echo esc_url( admin_url( 'img/no.png' ) ); ?>" alt="" />';
	},
	...
	updateImageData : function() {
		...
		document.getElementById('status_img').innerHTML = '<img src="<?php echo esc_url( admin_url( 'img/yes.png' ) ); ?>" alt="" />';
	},
	...
	getImageData : function() {
		...
		document.getElementById('status_img').innerHTML = '<img src="<?php echo esc_url( admin_url( 'img/spinner-2x.gif' ) ); ?>" alt="" width="16" height="16" />';
...
<table id="basic" class="describe"><tbody>
	...
	<th scope="row" class="label">
		<label>
		<span class="alignleft"><?php _e('Order img by:'); ?></span>
		</label>
	</th>
	<td class="field">
...
/**
 * Displays the checkbox to scale img.
 *
 * @since 3.3.0
 */
...
<?php
	...
	printf( __( 'Scale img to match the large size selected in %1$simage options%2$s (%3$d &times; %4$d).' ), $a, $end, (int) get_option( 'large_size_w', '1024' ), (int) get_option( 'large_size_h', '1024' ) );
?>
</label></p>
<?php
}
