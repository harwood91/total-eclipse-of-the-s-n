...
( function( $, window ) {
	var PressThis = function() {
		...
		/**
		 * Replace emoji img with chars and sanitize the text content.
		 */
		 ...
		 * @param link string Optional destination link, for img (defaults to src)
		 */
		...
		/**
		 * Add an image to the list of found img.
		 */
		...
		/**
		 * Render the detected img and embed for selection, if any
		 */
