...
class WP_Image_Editor_Imagick extends WP_Image_Editor {
	...
	public function load() {
		...
		try {
			...
			// Select the first frame to handle animated img properly
	...
	protected function thumbnail_image( $dst_w, $dst_h, $filter_name = 'FILTER_TRIANGLE', $strip_meta = true ) {
		...
		/**
		 * Filters whether to strip metadata from img when they're resized.
		 *
		...
		try {
			/*
			 * To be more efficient, resample large img to 5x the destination size before resizing
			...
			// Limit the bit depth of resized img to 8 bits per channel.
	...
	/**
	 * Resize multiple img from a single source.
	 *
	 * @since 3.5.0
	 * @access public
	 *
	 ...
	 *     }
	 * }
	 * @return array An array of resized img' metadata by size.
	 */
