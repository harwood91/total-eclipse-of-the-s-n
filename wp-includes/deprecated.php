 ...
 * @param bool $show_images Optional. Whether to show img (if defined).
 ...
 * @param bool $show_images Whether to show img (if defined).
 * @param string $orderby the order to output the links. E.g. 'id', 'name', 'url',
 *		'description', or 'rating'. Or maybe owner. If you start the name with an
 *		underscore the order will be reversed. You can also specify 'rand' as the
 *		order which will return links in a random order.
...
function get_attachment_icon_src( $id = 0, $fullsize = false ) {
	...
	if ( !$fullsize && $src = wp_get_attachment_thumb_url( $post->ID ) ) {
		...
		$icon_dir = apply_filters( 'icon_dir', get_template_directory() . '/img' );
...
function wp_load_image( $file ) {
	...
	// Set artificially high because GD uses uncompressed img in memory.
