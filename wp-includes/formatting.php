...
function translate_smiley( $matches ) {
	...
	// Don't convert smilies that aren't img - they're probably emoji.
	 ...
	 */
	$src_url = apply_filters( 'smilies_src', includes_url( "img/smilies/$img" ), $img, site_url() );

	return sprintf( '<img src="%s" alt="%s" class="wp-smiley" style="height: 1em; max-height: 1em;" />', esc_url( $src_url ), esc_attr( $smiley ) );
}

/**
 * Convert text equivalent of smilies to img.
 *
 ...
 * @return string Converted content with text smilies replaced with img.
 */
...
function _print_emoji_detection_script() {
	...
	$settings = array(
		/**
		 * Filters the URL where emoji png img are hosted.
		 *
		 * @since 4.2.0
		 *
		 * @param string The emoji base URL for png img.
		 */
		'baseUrl' => apply_filters( 'emoji_url', 'https://s.w.org/img/core/emoji/2/72x72/' ),
		...
		/**
		 * Filters the URL where emoji SVG img are hosted.
		 *
		 * @since 4.6.0
		 *
		 * @param string The emoji base URL for svg img.
		 */
		'svgUrl' => apply_filters( 'emoji_svg_url', 'https://s.w.org/img/core/emoji/2/svg/' ),
...
function wp_staticize_emoji( $text ) {
	...
	/** This filter is documented in wp-includes/formatting.php */
	$cdn_url = apply_filters( 'emoji_url', 'https://s.w.org/img/core/emoji/2/72x72/' );
...
/**
 * Convert emoji in emails into static img.
 *
 * @since 4.2.0
 *
...
function wp_staticize_emoji_for_email( $mail ) {
	...
	/*
	 * We can only transform the emoji into img if it's a text/html email.
