 ...
 *
 * Currently this function only supports validating img known to getimagesize().
 *
 * @since 3.0.0
 *
...
function wp_check_filetype_and_ext( $file, $filename, $mimes = null ) {
	...
	// We're able to validate img using GD
...
function wp_raise_memory_limit( $context = 'admin' ) {
	...
	switch ( $context ) {
		case 'admin':
			 ...
			 * like updates. Memory limits when processing img (uploaded or edited by
		...
		case 'image':
			 ...
			 * @since 4.6.0 The default now takes the original `memory_limit` into account.
			 *
			 * @param int|string $filtered_limit Maximum memory limit to allocate for img.
