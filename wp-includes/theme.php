...
function get_header_image_tag( $attr = array() ) {
	...
	/**
	 * Filters the markup of header img.
	 *
	 * @since 4.4.0
	 *
...
/**
 * Get random header image data from registered img in theme.
 *
 * @since 3.4.0
 *
 * @access private
...
/**
 * Get random header image url from registered img in theme.
 *
 * @since 3.2.0
 *
 ...
 * Also true if theme has multiple header img registered, no specific header image
...
/**
 * Get the header img uploaded for the current theme.
 *
 * @since 3.2.0
 *
 * @return array
