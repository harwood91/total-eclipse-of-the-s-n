...
class WP_Widget_Links extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$show_images = isset($instance['img']) ? $instance['img'] : true;
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance = array( 'img' => 0, 'name' => 0, 'description' => 0, 'rating' => 0 );
	...
	public function form( $instance ) {
		...
		//Defaults
		$instance = wp_parse_args( (array) $instance, array( 'img' => true, 'name' => true, 'description' => false, 'rating' => false, 'category' => false, 'orderby' => 'name', 'limit' => -1 ) );
		...
		<p>
		<input class="checkbox" type="checkbox"<?php checked($instance['img'], true) ?> id="<?php echo $this->get_field_id('img'); ?>" name="<?php echo $this->get_field_name('img'); ?>" />
		<label for="<?php echo $this->get_field_id('img'); ?>"><?php _e('Show Link Image'); ?></label><br />
